...
<form method="post" action="{{route('shops.store')}}" enctype="multipart/form-data">
    ...
    <div class="container">
        商家评分:   <input type="text" id="disabledTextInput" class="form-control" name="shop_rating" >
    </div><br/>
    ...
    <div class="container">
    商家审核：<input type="radio" id="inlineCheckbox1" value="1" name="status">正常

    <input type="radio" id="inlineCheckbox2" value="0" name="status">未审核
    <input type="radio" id="inlineCheckbox2" value="-1" name="status">禁用
    </div>
    {{csrf_field()}}
